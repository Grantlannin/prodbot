...
export const WIND_DOWN_FLOW_COPY = {
  ...
  betterUseNoted:
    'Noted. you can send that to yourself via email in the EOD if you want so you have it. Now before we organize for tomorrow, first thing we want to do is add specific context to everything you did today. This will go into the note section of the task so you know exactly where it\'s at, what needs to be done with it (if anything), or any additional context. If you don\'t want to add context, just click "no context. Next". Also, Make sure your notes are specific enough to be able to be understood tomorrow, or you will pay the \'clarity tax\' trying to figure out what you were talking about. A little extra time here goes a long way. Staying organized will keep you a beast. Let\'s begin.',
  contextIntro:
    'great. Now before we organize for tomorrow, first thing we want to do is add specific context to everything you did today. This will go into the note section of the task so you know exactly where it\'s at, what needs to be done with it (if anything), or any additional context. If you don\'t want to add context, just click "no context. Next". Also, Make sure your notes are specific enough to be able to be understood tomorrow, or you will pay the \'clarity tax\' trying to figure out what you were talking about. A little extra time here goes a long way. Staying organized will keep you a beast. Let\'s begin.',
