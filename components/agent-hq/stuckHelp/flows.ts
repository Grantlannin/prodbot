...
export const STUCK_HELP_OPTIONS: { id: StuckHelpPath; label: string }[] = [
  { id: 'starting', label: "I'm having trouble starting (friction/resistance)" },
...
export const STARTING_FLOW_COPY = {
  ...
  q1: 'what is the most important task we need to knock down?',
  chooseProject: 'choose task from project',
  createProject: 'create project/task',
  projectNamePlaceholder: 'Project name',
  addTaskPlaceholder: 'Add a task',
  noSavedProjects: 'No saved projects yet — use create project to add one.',
  teeUpPrep:
...
export const KICKSTART_DURATION_MS = KICKSTART_MINUTES * 60 * 1000;
...
export type StartingProjectMode = 'choose' | 'input' | null;
...
export interface StartingFlowState {
  ...
  projectMode: StartingProjectMode;
  projectId: string;
  projectName: string;
...
export const ORGANIZING_MVP_TASK_LIMIT = 2;
